...
export default function CachTinhHH() {

  const messages = [
    { id: 1, text: "Kính gửi: Toàn thể Quý Đại Lý" },
    { id: 2, text: "Đầu tiên, 789BET xin gửi lời cảm ơn chân thành tới những khách hàng đã dành sự tín nhiệm và ủng hộ với dịch vụ của 789BET trong thời gian qua." },
    { id: 3, text: " Chào đón sự kiện Luis Suárez trở thành Đại Sứ Độc Quyền chính thức tại 789BET. 789BET trân trọng kính mời Quý Đại Lý hợp tác tham gia vào hệ thống kinh doanh cùng phát triển với chế độ ưu đãi Hoa Hồng Siêu Khủng lên tới 60% bắt đầu từ 01/07/2023." },
    { id: 4, text: "  Dù Bạn là Ai đều được chào đón trở thành đối tác của Chúng Tôi, với phương châm cùng hợp tác phát triển bền vững, Chúng Tôi cam kết hợp  tác lâu dài và hỗ trợ tối đa tới các Đại Lý trong suốt quá trình hoạt động." }
  ];
  return (
    <>
      <div className="h-max pt-[28px] rounded-[30px] bg-[#ffffff] pb-[28px] ">
        <div className="w-[1168px] mx-4 mb-[4px] ">
          {messages.map((message) => (
            <p key={message.id} className="text-black leading-10 font-medium">
              {message.text}
            </p>
          ))}
          ...
          <p className="  text-black  leading-10 font-medium">
            - Đại Lý lợi nhuận ròng là 1 tỷ, có 3 hội viên hợp lệ, tỷ lệ hoa
            hồng là 35%
          </p>
          <p className="  text-black  leading-10 font-medium">
            - Đại Lý lợi nhuận ròng là 1 tỷ, có 20 hội viên hợp lệ, tỷ lệ hoa
            hồng là 55%
          </p>
          <p className="  text-black  leading-10 font-medium">
            * Số hội viên hợp lệ tối thiểu mà Đại Lý cần đạt để nhận hoa hồng là
            3 hội viên.
          </p>
          <p className="  text-black  leading-10 font-medium">
          ...
          <p className="  text-black  leading-10 font-medium">
            * Nếu trong tháng Đại Lý không đạt được 2 điều kiện trên thì sẽ
            không được tính hoa hồng tháng đó.
          </p>
          <div
            className="wp-notification"
            style={{
              background:
                "linear-gradient(0deg, rgb(244, 154, 37) 10.31%, rgb(247, 186, 34) 71.66%), linear-gradient(rgb(255, 128, 0) -0.74%, rgba(255, 128, 0, 0) 111.57%)",
              padding: "20px",
              borderRadius: "20px",
              marginTop: "10px",
              marginBottom: "10px",
            ...
            <p className="text-black leading-10 font-medium text-[30px]">
              ...
              <span className="text-[#000]">
                ...
                công ty mức hoa hồng cố định là 25%. Chế độ này Từ ngày
                01/02/2024 hoa hồng sẽ được điều chỉnh cố định
                <span className="text-[#0d4287]" style={{ fontWeight: 700 }}>
                  {" "}
                  vĩnh viễn nhận mức hoa hồng 15%.{" "}
                </span>
                ( Từ khóa nội bộ ví dụ link mới 789BET, link 789BET , Đăng nhập
                789BET... Ngoài ra nếu phát hiện seo các từ khóa liên quan các
                web trong liên minh OKVIP cũng áp dụng mức hoa hồng 15% )
              </span>
              .
            </p>
          </div>
          ...
          <p className="  text-black  leading-10 font-medium">
            ...
            nhận thưởng tiền thưởng phát triển hội viên mới, mỗi hội viên mới
            hợp lệ thưởng 200,000 VND, không giới hạn số tiền.
          </p>
          <table className="w-full table-fixed border border-slate-300 text-lg center">
            <thead>
              <tr className="bg-white h-[64px]  border-black-300 ">
            ...
            <tbody>
              <tr className="bg-white text-center h-[52.15px] ">
                ...
                <td className="border border-black">
                  200,000 VND /01 hội viên
                </td>
              </tr>
            </tbody>
          </table>
          <p className="  text-black  leading-10 font-medium">
            * Hội viên mới hợp lệ : hội viên mới nạp đầu trong tháng, có tích
            luỹ nạp tiền ≥ 1,000 điểm, cược hợp lệ ≥ 3,000 điểm (dựa vào đánh
            gía tổng hợp Ip, tính hoạt động và tính nạp lại phê duyệt).
          </p>
          <p className="  text-black  leading-10 font-medium">
            <span className="text-[#FF3B1A]">*Chú ý:</span> Đại Lý Google SEO/
            ADS chạy từ khoá nội bộ của công ty không được tham gia chương trình
            tiền thưởng hội viên mới.
          </p>
          <p className="  text-black  leading-10 font-medium">
            * Chế độ này không áp dụng với sản phẩm{" "}
            <span className="text-[#FF3B1A]">Xổ Số</span>.
          ...
          <p className="  text-black  leading-10 font-medium">
            * Hoa hồng và tiền thưởng hội viên mới sẽ được phát trước ngày 10
            mỗi tháng.
          </p>
          <p className="  text-black  leading-10 font-medium">
          ...
          <p className="  text-black  leading-10 font-medium">
            * Nếu Đại Lý có lợi nhuận dương thì sẽ trừ vào lợi nhuận các tháng
            sau cho tới khi hết lợi nhuận dương.
          </p>
          <p className="  text-black  leading-10 font-medium">
          ...
          <p className="  text-black  leading-10 font-medium">
            * 789BET có quyền đơn phương chấm dứt hợp tác nếu phát hiện Đại Lý
            sử dụng hành vi lạm dụng để trục lợi hoa hồng không chính đáng.
          </p>
          <p className="  text-black  leading-10 font-medium">
          ...
          <p className="  text-black  leading-10 font-medium">
            - Tài khoản game của Đại Lý không nằm dưới link Đại Lý của chính
            mình.
          </p>
          <p className="  text-black  leading-10 font-medium">
          ...
          <p className="  text-black  leading-10 font-medium">
            ...
            chuyên nghiệp được sử dụng rộng rãi bởi cá nhân cũng như công ty,
            với mục đích quảng bá công ty cá cược hàng đầu đến với khách hàng.
          </p>
          <p className="   text-black  leading-10 font-medium">
            ...
            trình hợp tác giữa Công ty và Quý đối tác. Mọi hình thức hợp tác,
            vui lòng liên hệ trực tiếp với Chúng Tôi qua telegram:&nbsp;
            <a
              target="_blank"
