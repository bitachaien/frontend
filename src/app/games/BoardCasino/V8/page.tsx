...
export default function ListGameOptions({}: {}) {
  ...
  return (
    ...
    >
        ...
        <div className=" w-[850px] flex items-center flex-wrap py-[10px] gap-4 font-roHe">
          <p
            ...
            className={`text-white ${
              activeItem !== "hot" ? `${styles[`v8`]}` : `${styles[`v8Hover`]}`
          ...
          <p
            ...
            className={`text-white ${
              activeItem !== "co" ? `${styles[`v8`]}` : `${styles[`v8Hover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Cờ
          </p>
          ...
          <p
            ...
            className={`text-white ${
              activeItem !== "orther" ? `${styles[`v8`]}` : `${styles[`v8Hover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Khác
          </p>
      ...
      {activeItem === "hot" && <IntroducingTheGameTableGame gamename={gameName.V8} />}
