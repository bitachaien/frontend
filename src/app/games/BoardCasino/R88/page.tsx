...
export default function ListGameOptions({}: {}) {
  ...
  return (
    ...
    >
        ...
        <div className=" w-[850px] flex items-center flex-wrap py-[10px] gap-4 font-roHe">
          <p
            ...
            className={`text-white ${
              activeItem !== "hot" ? `${styles[`r88`]}` : `${styles[`r88Hover`]}`
          ...
          <p
            ...
            className={`text-white text-[15px] h-[30px]  ${
              activeItem !== "all" ? `${styles[`r88`]}` : `${styles[`r88Hover`]}`
          ...
          <p
            onClick={() => onClickFilter("dt")}
            className={`text-white ${
              activeItem !== "dt" ? `${styles[`r88`]}` : `${styles[`r88Hover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Game Điện Tử
          </p>
          ...
          <p
            onClick={() => onClickFilter("gioithieu")}
            className={`text-white ${
              activeItem !== "gioithieu" ? `${styles[`r88`]}` : `${styles[`r88Hover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Giới Thiệu Trò Chơi
          </p>

          <p
            onClick={() => onClickFilter("orther")}
            className={`text-white ${
              activeItem !== "orther" ? `${styles[`r88`]}` : `${styles[`r88Hover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Khác
          </p>
      ...
      {activeItem === "hot" && <IntroducingTheGameTableGame gamename={gameName.R88} />}
