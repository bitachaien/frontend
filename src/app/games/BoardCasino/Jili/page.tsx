...
export default function ListGameOptions({}: {}) {
  ...
  //       gpIds: [`${ListGameConfig.JiLiGaming}`],
  //     });
  ...
  return (
    ...
    >
        ...
        <div className=" w-[850px] flex items-center flex-wrap py-[10px] gap-4 font-roHe">
          <p
            ...
            className={`text-white ${
              activeItem !== "hot" ? `${styles[`jili`]}` : `${styles[`jiliHover`]}`
            } text-[15px] h-[30px]  px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Hot Nhất
          </p>
          <p
            onClick={() => onClickFilter("new")}
            className={`text-white ${
              activeItem !== "new" ? `${styles[`jili`]}` : `${styles[`jiliHover`]}`
            } text-[15px] h-[30px]  px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Mới Nhất
          </p>
          <p
            ...
            className={`text-white text-[15px] h-[30px]  ${
              activeItem !== "co" ? `${styles[`jili`]}` : `${styles[`jiliHover`]}`
          ...
          <p
            ...
            className={`text-white ${
              activeItem !== "orther" ? `${styles[`jili`]}` : `${styles[`jiliHover`]}`
            } text-[15px] h-[30px] px-4 py-2 flex justify-center items-center rounded-full cursor-pointer`}
          >
            Trò Chơi Khác
          </p>
      ...
      {activeItem === "hot" && <IntroducingTheGameTableGame gamename={gameName.Jili} />}
